...
const Achievements = () =>
{
    ...
    const dummyachivments = [
        {id: 0, title:"Unlimited power!", desc: "Vote on a poll during a council meeting",
            rewards: {xp: 50, title:"My opinion matters", cosmetic: undefined}},
        {id: 1, title:"Touch some grass", desc: "Participate in a meeting in person",
    ...
    return (
        <Container>
            ...
            <DisplaySection>
                {
                    sections[selected].data.map((e, i) => (
                         sections[selected].component(i)
                    ))
                }
            </DisplaySection>
        </Container>
